...
The REST API documentation can be found on [docs.knock-mapi.com](https://docs.knock-mapi.com). The full API of this library can be found in [api.md](api.md).
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/knock-mapi-typescript.git
```
...
1. Via the `KNOCK_MAPI_LOG` environment variable
...
const client = new KnockMapi({
  logger: logger.child({ name: 'KnockMapi' }),
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/knock-mapi-typescript/issues) with questions, bugs, or suggestions.
