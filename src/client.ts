...
import { Partial as PartialResource, // rename to PartialResource to avoid confusion with Partial<T> in TypeScript
  PartialListParams, PartialRetrieveParams, PartialUpsertParams, PartialUpsertResponse, PartialValidateParams, PartialValidateResponse, Partials, PartialsEntriesCursor } from './resources/partials';
