...
export const parseLogLevel = (maybeLevel: string | undefined, sourceName: string, client: KnockMgmt): LogLevel | undefined => {
  if (!maybeLevel) {
    return undefined;
  }
...
export function loggerFor(client: KnockMgmt): Logger {
