...
describe('resource workflows', () => {
  ...
  test.skip('activate: only required params', async () => {
    const responsePromise = client.workflows.activate('workflow_key', { environment: 'development', status: true });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
  ...
  test.skip('run: only required params', async () => {
    const responsePromise = client.workflows.run('workflow_key', { environment: 'development', recipients: ['dnedry'] });
    const rawResponse = await responsePromise.asResponse();
    expect(rawResponse).toBeInstanceOf(Response);
    const response = await responsePromise;
    expect(response).not.toBeInstanceOf(Response);
